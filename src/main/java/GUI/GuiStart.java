...
public class GuiStart extends JPanel implements Runnable {
	...
	private void loadPictures() {
		try {
			bombe = ImageIO.read(new File(this.getClass().getResource("/Bombe.png").toURI()));
			player1Bombe = ImageIO.read(new File(this.getClass().getResource("/BombeSpieler1.png").toURI()));
			player2Bombe = ImageIO.read(new File(this.getClass().getResource("/BombeSpieler2.png").toURI()));
			player1 = ImageIO.read(new File(this.getClass().getResource("/Spieler1.png").toURI()));
			player2 = ImageIO.read(new File(this.getClass().getResource("/Spieler2.png").toURI()));
			wall = ImageIO.read(new File(this.getClass().getResource("/Wall.png").toURI()));
			explosion = ImageIO.read(new File(this.getClass().getResource("/Explosion.png").toURI()));
			freiesFeld = ImageIO.read(new File(this.getClass().getResource("/LeeresFeld.png").toURI()));
